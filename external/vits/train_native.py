...
def train_and_evaluate(rank, epoch, hps, nets, optims, schedulers, scaler, loaders, logger, writers):
  ...
  net_g.train()
  net_d.train()
  for batch_idx, (x,x_lengths,spec,spec_lengths,mel,mel_lengths,y,y_lengths,f0,f0_lengths) in enumerate(train_loader):
    ...
    with autocast(enabled=hps.train.fp16_run):
      ...
      with autocast(enabled=False):
        ...
        loss_gen_all = (loss_mel + loss_dur + loss_kl + (10 * loss_wav) + loss_gen + loss_fm)
    ...
    if rank==0:
      if global_step % hps.train.log_interval == 0:
        ...
        losses = [loss_disc_all,loss_mel,loss_dur,loss_kl,loss_gen,loss_fm]
        ...
        scalar_dict.update({"loss/g/mel": loss_mel,"loss/g/dur": loss_dur,"loss/g/kl": loss_kl,"loss/g/gen": loss_gen,"loss/g/fm": loss_fm})
...
def evaluate(hps, generator, eval_loader, writer_eval, rank=0):
    generator.eval()
    with torch.no_grad():
      for batch_idx, (x,x_lengths,spec,spec_lengths,mel,mel_lengths,y,y_lengths,f0,f0_lengths) in enumerate(eval_loader):
        ...
        break
      y_hat, attn, mask, *_ = generator.module.infer(x,x_lengths,mel,mel_lengths,f0,f0_lengths,max_len=1000)
